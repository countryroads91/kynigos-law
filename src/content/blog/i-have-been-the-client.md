...
| "The 'Reimbursement' Demand is Based on False Premises" | "The 'Reimbursement' Demand Is Unsupported" |
| "As the attached first page of the executed sales contract (Exhibit A) confirms" | "As reflected on the first page of the executed contract of sale (Exhibit A)" |

*Synonyms. Not edits. The text on the left means exactly what the text on the right means.*
